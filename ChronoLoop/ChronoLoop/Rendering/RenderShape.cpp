...
namespace Epoch {
	...
	void RenderShape::Render() {
		...
		Renderer::Instance()->GetContext()->IASetIndexBuffer(IndexBufferManager::GetBuffer(), DXGI_FORMAT_R32_UINT, 0);
		Renderer::Instance()->GetContext()->IASetVertexBuffers(0, 1, &vBuffer, &stride, &offset);
